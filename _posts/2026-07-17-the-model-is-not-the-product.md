...
![A three-stage harness, plan then generate then evaluate, with a verification gate between each step]({{ site.url }}/assets/images/posts/the-model-is-not-the-product.png)
